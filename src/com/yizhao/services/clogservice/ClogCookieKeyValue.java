...
public class ClogCookieKeyValue extends AbstractLoggable{
    ...
    /** Constant indicating the default format of a timestamp string */
    ...
    public String toCsv(Collection<Object> permanentAttributes) {
        ...
        List<Object> attributes =
                CollectionUtil.<Object> collect(
                        ...
                        keyId,
                        value,
                        Util.timestampToString(keyTs, Constants.DEFAULT_TIMESTAMP_FORMAT),
                        Util.timestampToString(lastPixelTs, Constants.DEFAULT_TIMESTAMP_FORMAT) );
